...
const Luxury: NextPage = () => {
  const router = useRouter();
  const [duration, setDuration] = useState("1");

  const handleRentNow = () => {
    const productData = {
      id: 2, // Unique product ID for Luxury item
      productName: "Luxury Sedan",
      image:
        "https://platform.cstatic-images.com/large/in/v2/stock_photos/e74b9fc3-5d68-4746-a779-91b3d7f7bf0b/662ad619-8301-4c97-bb4e-0d7775cde919.png",
      pricePerDay: 250,
    ...
    // Save the product data in localStorage as an array
      ...
      <div className="flex bg-white rounded-lg shadow dark:bg-gray-800 flex-col md:flex-row">
        ...
        >
          ...
          <div className="flex items-center mt-4 mb-6">
            <label
              htmlFor="rental-duration-luxury"
              className="mr-2 text-gray-700 dark:text-gray-300"
            >
              Rental Duration (days):
            </label>
            <input
              id="rental-duration-luxury"
              type="number"
              min="1"
              value={duration}
          ...
          <p className="text-sm text-gray-500 dark:text-gray-300">
            Free insurance included with every rental.
          </p>
        </form>
      </div>
    </div>
